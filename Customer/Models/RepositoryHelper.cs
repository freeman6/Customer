namespace Customer.Models
{
	public static class RepositoryHelper
	{
		...
		public static viwCustomerSummaryRepository GetviwCustomerSummaryRepository()
		{
			var repository = new viwCustomerSummaryRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static viwCustomerSummaryRepository GetviwCustomerSummaryRepository(IUnitOfWork unitOfWork)
		{
			var repository = new viwCustomerSummaryRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
